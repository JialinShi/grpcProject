...
const char descriptor_table_protodef_chat_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\nchat.proto\022\004chat\"C\n\013ChatMessage\022\020\n\010use"
    "rname\030\001 \001(\t\022\017\n\007message\030\002 \001(\t\022\021\n\ttimestam"
    "p\030\003 \001(\0032\?\n\013ChatService\0220\n\004Chat\022\021.chat.Ch"
    "atMessage\032\021.chat.ChatMessage(\0010\001b\006proto3"
};
...
const ::_pbi::TcParseTable<2, 3, 0, 40, 2> ChatMessage::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
